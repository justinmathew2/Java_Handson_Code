...
{
    void ReturnBook();
    void  BorrowBook()throws MyException;
    void Display();
}
class Student implements Library
{
   ...
   int no1;
   @Override
   public void BorrowBook()throws MyException
   {
       ...
       else
       {
           ...
           throw new MyException("You cannot borrow more than 5 books...");
       }
   }
   @Override
...
class Faculty implements Library
{
   ...
   public void BorrowBook() throws MyException
   {
       ...
       {
           throw new MyException("You cannot borrow more than 7 books.....");
       }}
   @Override
   public void Display()
   {
        ...
        switch(ch){
            case 1:
                ...
                case 2:
                    ...
                    for(int i=0;i<3;i++)
                    {
                        System.out.println("Enter details for "+(i+1)+" faculties");
